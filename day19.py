# Solution taken from:
# https://www.youtube.com/watch?v=khzWu1_7iWA&list=WL&index=12&ab_channel=anthonywritescode
...
INPUT_TXT = os.path.join(os.path.dirname(__file__), "./data/day19.txt")
...
class Scanner(NamedTuple):
    ...
    def from_str(cls, s: str) -> Scanner:
        ...
        points = []
        for line in lines[1:]:
            x, y, z = parse_numbers_comma(line)
            points.append((x, y, z))
...
def compute(s: str) -> tuple:
    ...
    return (len(all_points), max_dist)
