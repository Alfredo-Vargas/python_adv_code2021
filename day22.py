# taken from
# https://github.com/jonathanpaulson/AdventOfCode/blob/master/2021/22.py
# Message: Coordinate compression. Another alternative is cube segmentation in sub cubes
import sys
import re
